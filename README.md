...
```javascript
itercumax = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-iter-cumax@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/stats-iter-cumax/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-iter-cumax/actions/workflows/test.yml?query=branch:v0.1.1
